...
var server=http.createServer(function(request,response){
    ...
    //->request.url:存放的是客户端请求的文件资源的目录和名称以及传递给服务器的数据，例如：客户端请求的地址：http://192.168.0.32/index.html?name=candy&age=28我们服务端通过request.url获取到的是:/index.html?name=zhufeng&age=7
